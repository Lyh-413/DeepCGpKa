    ...
    def __init__(
        ...
        *,
        ...
        self.spaceencoding=nn.Sequential(
            Rearrange('b n m c -> b c n m'),
            nn.InstanceNorm2d(num_features=3, affine=True, track_running_stats=True, momentum=0.9),
            nn.Conv2d(in_channels=3, out_channels=64, kernel_size=(1, 1), stride=1, padding='same'),
            Rearrange('b c n m -> b n m c')
        )
        '''
